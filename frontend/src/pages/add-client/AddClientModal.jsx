...
function AddClientModal({ onClose, onClientAdded }) {
  ...
  const validateForm = () => {
    ...
    if (formData.RG && !/^\d+$/.test(formData.RG)) {
      newErrors.RG = "Este campo aceita apenas números.";
    }
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    // A validação agora apenas retorna true ou false, sem alert
    if (!validateForm()) {
      console.log("Validação falhou. Erros:", errors);
      return; 
    }
    if (!formData.NOMECLIENTE || !formData.CPF) {
        alert("Nome e CPF são obrigatórios."); // Mantemos este para campos principais
        return;
    }
      ...
      <div className="modal-content" onClick={(e) => e.stopPropagation()}>
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-grid">
            {/* O resto do JSX continua exatamente o mesmo, com as mensagens de erro abaixo de cada campo */}
            ...
            <div className="input-group">
              ...
              {errors.RG && <p className="error-text">{errors.RG}</p>}
            </div>
            ...
            <div className="input-group"><hr /></div>
            <div className="input-group">
